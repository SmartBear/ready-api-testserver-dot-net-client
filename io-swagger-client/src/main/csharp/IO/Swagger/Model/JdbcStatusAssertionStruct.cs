...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JdbcStatusAssertionStruct : Assertion,  IEquatable<JdbcStatusAssertionStruct>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JdbcStatusAssertionStruct" /> class.
        /// </summary>
        public JdbcStatusAssertionStruct()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JdbcStatusAssertionStruct {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JdbcStatusAssertionStruct);
        }

        /// <summary>
        /// Returns true if JdbcStatusAssertionStruct instances are equal
        /// </summary>
        /// <param name="other">Instance of JdbcStatusAssertionStruct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JdbcStatusAssertionStruct other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
