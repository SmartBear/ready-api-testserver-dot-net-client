...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimpleNotContainsAssertion : Assertion,  IEquatable<SimpleNotContainsAssertion>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleNotContainsAssertion" /> class.
        /// </summary>
        public SimpleNotContainsAssertion()
        {
        ...
        /// <summary>
        /// Specifies if the search is case-sensitive (false) or not (true). Ignored, if you search with regular expressions.
        /// </summary>
        /// <value>Specifies if the search is case-sensitive (false) or not (true). Ignored, if you search with regular expressions.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SimpleNotContainsAssertion {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SimpleNotContainsAssertion);
        }

        /// <summary>
        /// Returns true if SimpleNotContainsAssertion instances are equal
        /// </summary>
        /// <param name="other">Instance of SimpleNotContainsAssertion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleNotContainsAssertion other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
