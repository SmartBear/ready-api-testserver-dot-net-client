...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FormDataContentDisposition :  IEquatable<FormDataContentDisposition>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FormDataContentDisposition);
        }

        /// <summary>
        /// Returns true if FormDataContentDisposition instances are equal
        /// </summary>
        /// <param name="other">Instance of FormDataContentDisposition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormDataContentDisposition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
